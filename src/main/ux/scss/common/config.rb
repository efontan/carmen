#Variables
resources	= File.join("..", "..", "..", "webapp", "WEB-INF")
...
css_dir           = File.join(resources,  "css", product)

#Directorio Images relativo al config.rb
images_dir        = File.join(resources, "img", "ux")

#Directorio JS relativo al config.rb
javascripts_dir   = File.join(resources, "js")

#Directorio Fonts relativo al config.rb
fonts_dir		  = File.join(resources, "fonts")
