define([
		...
		"common/modules/overlay", 

		"modules/service-definition/common-services",

		"common/modules/map", "game/modules/ar_map", "common/modules/gmaps",

		"common/helpers/tmpl-helpers",

		"templates/hotel-map", "templates/op-loading"

	],

	function(_, logger, localization, extraData, overlay, commonServices) {
		...
		function _getFormData(callback) {
			...
			amplify.request({
				resourceId: "selfservice.operations.common.getSpecialRequest",
				data: {
